...
public class AMQStoreEmbeddedBroker {
	...
	public void createEmbeddedBroker() throws Exception {
		...
		/*
		 * BrokerService broker = new BrokerService(); //initialize the
		 * PersistenceAdaptorFactory AMQPersistenceAdapterFactory
		 * persistenceFactory = new AMQPersistenceAdapterFactory();
		 * 
